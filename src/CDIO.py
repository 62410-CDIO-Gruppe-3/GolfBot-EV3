...
def _():
    ...
    IMAGE_PATH = "C:\\Users\\hatal\\GolfBot-EV3\\src\\assets\\test_image5.jpg"
    WINDOW_NAME = "Select 4 points"
    TRANSFORM_WIDTH, TRANSFORM_HEIGHT = 1200, 1800
...
@app.cell
def _(TRANSFORM_HEIGHT, TRANSFORM_WIDTH, cv2, np, points, sys):
    # ----- COMPUTE HOMOGRAPHY -----
